...
# ==========================================
# Module 5: 随机森林 对比实验主流程 (绝对双向物理隔离)
# ==========================================
if __name__ == "__main__":
    print("=== ECI Binocular Screening System (Random Forest Baseline Version) ===")
    ...
    all_healthy_images = sorted(all_healthy_images) # 确保按时间序列顺序排列
    ...
    print("\n[Model Training] Training Random Forest Classifier...")
    clf_rf = RandomForestClassifier(n_estimators=100, class_weight='balanced', max_depth=5, random_state=42)
    ...
    print("\n==================================================")
    print("        System Evaluation Report (Random Forest Baseline)")
    print("==================================================")
    ...
    try:
        ...
        plt.title("Random Forest Baseline: Feature Importance Analysis", fontsize=14, fontweight='bold')
        ...
        print("\n[Plot Generated] Random Forest feature importance chart saved as 'feature_importance_rf.png'.")
    ...
    print("\n[Model Saving] Saving the trained Random Forest model...")
    try:
        joblib.dump(clf_rf, model_save_path)
        print(f"  -> Model successfully saved to: {model_save_path}")
        print("     (Ready to be loaded by the Demo application.)")
    except Exception as e:
